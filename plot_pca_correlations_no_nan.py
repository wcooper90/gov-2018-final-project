...
X1 = variables_PC1[:5]
X2 = variables_PC1[-5:][::-1]
Y1 = correlations_PC1[:5]
Y2 = correlations_PC1[-5:][::-1]
...
plt.savefig('./pca_1_no_nan_lowest_correlations.png', dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig('./pca_1_no_nan_highest_correlations.png', dpi=300, bbox_inches="tight")
plt.close()


X1 = variables_PC2[:5]
X2 = variables_PC2[-5:][::-1]
Y1 = correlations_PC2[:5]
Y2 = correlations_PC2[-5:][::-1]
X_axis = np.arange(len(X1))
plt.style.use('ggplot')
plt.bar(X_axis, Y1, 0.4)
plt.xticks(X_axis, X1, rotation=30)
...
plt.savefig('./pca_2_no_nan_lowest_correlations.png', dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig('./pca_2_no_nan_highest_correlations.png', dpi=300, bbox_inches="tight")
plt.close()
